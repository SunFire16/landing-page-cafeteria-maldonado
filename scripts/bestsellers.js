...
import { getBestSellers } from './api.js?v=20260505-tv-dense19';
import { el, clear, formatPrice, safeImage } from './dom.js?v=20260505-tv-dense19';
import { getCurrentLocation } from './location.js?v=20260505-tv-dense19';
