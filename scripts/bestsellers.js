...
import { getBestSellers } from './api.js?v=20260502-tv-dense7';
import { el, clear, formatPrice, safeImage } from './dom.js?v=20260502-tv-dense7';
import { getCurrentLocation } from './location.js?v=20260502-tv-dense7';
